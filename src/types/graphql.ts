...
export type GithubProfileQuery = { __typename?: 'Query', user?: Maybe<{ __typename?: 'User', name?: Maybe<string>, login: string, bio?: Maybe<string>, avatarUrl: any, repositories: { __typename?: 'RepositoryConnection', nodes?: Maybe<Array<Maybe<{ __typename?: 'Repository', name: string, description?: Maybe<string>, updatedAt: any, primaryLanguage?: Maybe<{ __typename?: 'Language', color?: Maybe<string>, name: string }> }>>> } }> };
...
/**
 * __useGithubProfileQuery__
 *
 * To run a query within a React component, call `useGithubProfileQuery` and pass it any options that fit your needs.
 * When your component renders, `useGithubProfileQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGithubProfileQuery({
 *   variables: {
 ...
 * });
 */
export function useGithubProfileQuery(baseOptions: Apollo.QueryHookOptions<GithubProfileQuery, GithubProfileQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GithubProfileQuery, GithubProfileQueryVariables>(GithubProfileDocument, options);
      }
export function useGithubProfileLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GithubProfileQuery, GithubProfileQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GithubProfileQuery, GithubProfileQueryVariables>(GithubProfileDocument, options);
        }
export type GithubProfileQueryHookResult = ReturnType<typeof useGithubProfileQuery>;
export type GithubProfileLazyQueryHookResult = ReturnType<typeof useGithubProfileLazyQuery>;
export type GithubProfileQueryResult = Apollo.QueryResult<GithubProfileQuery, GithubProfileQueryVariables>;